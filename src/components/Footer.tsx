...
export default function Footer() {
  return (
    <>
      <footer className='w-full flex flex-row items-center justify-center gap-8 absolute z-50 bottom-0 left-1/2 -translate-x-1/2 bg-black text-white text-xs shadow-xl  border-t border-t-0.5 border-t-gray-300 '>
        <div className="max-w-md w-full flex flex-row items-center justify-center gap-4 text-black dark:text-white">
          <div className="">xNFT Scaffold</div>
